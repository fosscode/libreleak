...
pub enum Detector {
    Prefix { prefix: &'static str, min_len: usize, charset: Charset },
    Contains { needle: &'static str },
    KeyValue { keys: &'static [&'static str], min_value_len: usize },
    /// Detect endpoints/URLs in config (for local AI services)
    Endpoint { keys: &'static [&'static str], patterns: &'static [&'static str] },
}
...
impl Charset {
    pub fn matches(self, c: char) -> bool {
        match self {
            ...
            Charset::Base64 => c.is_ascii_alphanumeric() || c == '+' || c == '/' || c == '=' || c == '.',
            Charset::Hex => c.is_ascii_hexdigit(),
            Charset::Url => c.is_ascii_alphanumeric()
                || matches!(c, '-' | '_' | '.' | '~' | ':' | '/' | '?' | '#' | '[' | ']' | '@' | '!' | '$' | '&' | '\'' | '(' | ')' | '*' | '+' | ',' | ';' | '=' | '%'),
        }
    }
}
...
pub fn builtin_rules() -> Vec<Rule> {
    vec![
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "AKIA", min_len: 20, charset: Charset::AlphaNum },
        },
        Rule {
            id: "aws-secret-key",
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "ghp_", min_len: 40, charset: Charset::AlphaNum },
        },
        Rule {
            id: "github-oauth",
            name: "GitHub OAuth Access Token",
            detector: Detector::Prefix { prefix: "gho_", min_len: 40, charset: Charset::AlphaNum },
        },
        Rule {
            id: "github-app",
            name: "GitHub App Token",
            detector: Detector::Prefix { prefix: "ghu_", min_len: 40, charset: Charset::AlphaNum },
        },
        Rule {
            id: "github-refresh",
            name: "GitHub Refresh Token",
            detector: Detector::Prefix { prefix: "ghr_", min_len: 40, charset: Charset::AlphaNum },
        },
        Rule {
            id: "github-fine-grained",
            name: "GitHub Fine-Grained PAT",
            detector: Detector::Prefix { prefix: "github_pat_", min_len: 80, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "glpat-", min_len: 26, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "gitlab-pipeline",
            name: "GitLab Pipeline Token",
            detector: Detector::Prefix { prefix: "glptt-", min_len: 26, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "gitlab-runner",
            name: "GitLab Runner Token",
            detector: Detector::Prefix { prefix: "glrt-", min_len: 26, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "AIza", min_len: 39, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "sk-or-v1-", min_len: 64, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            id: "openai-api-key",
            name: "OpenAI API Key",
            detector: Detector::Prefix { prefix: "sk-", min_len: 48, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "openai-project-key",
            name: "OpenAI Project API Key",
            detector: Detector::Prefix { prefix: "sk-proj-", min_len: 48, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "sk-ant-", min_len: 40, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "anthropic-api-key-env",
            name: "Anthropic API Key (env)",
            detector: Detector::KeyValue {
                keys: &["ANTHROPIC_API_KEY", "CLAUDE_API_KEY", "anthropic_api_key", "claude_api_key"],
                min_value_len: 40,
            },
        },
        ...
        Rule {
            id: "xai-api-key",
            name: "xAI API Key",
            detector: Detector::Prefix { prefix: "xai-", min_len: 40, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "xai-api-key-env",
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "pplx-", min_len: 48, charset: Charset::AlphaNum },
        },
        Rule {
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "fw_", min_len: 40, charset: Charset::AlphaNumDash },
        },
        Rule {
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "sk-", min_len: 32, charset: Charset::AlphaNum },
        },
        Rule {
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "csk-", min_len: 40, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "pa-", min_len: 40, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "esecret_", min_len: 40, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "xoxb-", min_len: 50, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "slack-user-token",
            name: "Slack User Token",
            detector: Detector::Prefix { prefix: "xoxp-", min_len: 50, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "slack-app-token",
            name: "Slack App Token",
            detector: Detector::Prefix { prefix: "xapp-", min_len: 50, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "sk_live_", min_len: 32, charset: Charset::AlphaNum },
        },
        Rule {
            id: "stripe-restricted-key",
            name: "Stripe Restricted Key",
            detector: Detector::Prefix { prefix: "rk_live_", min_len: 32, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            id: "twilio-api-key",
            name: "Twilio API Key",
            detector: Detector::Prefix { prefix: "SK", min_len: 34, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "SG.", min_len: 69, charset: Charset::Base64 },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "npm_", min_len: 36, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            id: "pypi-token",
            name: "PyPI API Token",
            detector: Detector::Prefix { prefix: "pypi-", min_len: 50, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "MTA", min_len: 59, charset: Charset::Base64 },
        },
        Rule {
            id: "discord-bot-token-mti",
            name: "Discord Bot Token (MTI)",
            detector: Detector::Prefix { prefix: "MTI", min_len: 59, charset: Charset::Base64 },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "shpat_", min_len: 38, charset: Charset::AlphaNum },
        },
        Rule {
            id: "shopify-custom-app-token",
            name: "Shopify Custom App Token",
            detector: Detector::Prefix { prefix: "shpca_", min_len: 38, charset: Charset::AlphaNum },
        },
        Rule {
            id: "shopify-private-app-token",
            name: "Shopify Private App Token",
            detector: Detector::Prefix { prefix: "shppa_", min_len: 38, charset: Charset::AlphaNum },
        },
        Rule {
            id: "shopify-shared-secret",
            name: "Shopify Shared Secret",
            detector: Detector::Prefix { prefix: "shpss_", min_len: 38, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "dapi", min_len: 32, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["TELEGRAM_BOT_TOKEN", "TELEGRAM_TOKEN", "telegram_bot_token", "telegram_token", "BOT_TOKEN"],
                min_value_len: 40,
            },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "EAAAE", min_len: 50, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "square-access-token-sandbox",
            name: "Square Sandbox Access Token",
            detector: Detector::Prefix { prefix: "EAAAl", min_len: 50, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "NRAK-", min_len: 32, charset: Charset::AlphaNum },
        },
        Rule {
            id: "newrelic-license-key",
            name: "New Relic License Key",
            detector: Detector::KeyValue {
                keys: &["NEW_RELIC_LICENSE_KEY", "NEWRELIC_LICENSE_KEY", "newrelic_license_key"],
                min_value_len: 40,
            },
        },
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["SUPABASE_ANON_KEY", "SUPABASE_KEY", "supabase_anon_key", "NEXT_PUBLIC_SUPABASE_ANON_KEY"],
                min_value_len: 30,
            },
        },
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["SUPABASE_SERVICE_ROLE_KEY", "SUPABASE_SERVICE_KEY", "supabase_service_role_key"],
                min_value_len: 30,
            },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "pscale_pw_", min_len: 40, charset: Charset::AlphaNum },
        },
        Rule {
            id: "planetscale-token",
            name: "PlanetScale OAuth Token",
            detector: Detector::Prefix { prefix: "pscale_tkn_", min_len: 40, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["CLOUDFLARE_API_TOKEN", "CF_API_TOKEN", "cloudflare_api_token"],
                min_value_len: 40,
            },
        },
        Rule {
        ...
        Rule {
            id: "linear-api-key",
            name: "Linear API Key",
            detector: Detector::Prefix { prefix: "lin_api_", min_len: 40, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "secret_", min_len: 43, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "pat", min_len: 50, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "figd_", min_len: 40, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "dop_v1_", min_len: 64, charset: Charset::AlphaNum },
        },
        Rule {
            id: "digitalocean-pat",
            name: "DigitalOcean Personal Access Token",
            detector: Detector::Prefix { prefix: "doo_v1_", min_len: 64, charset: Charset::AlphaNum },
        },
        Rule {
            id: "digitalocean-refresh-token",
            name: "DigitalOcean Refresh Token",
            detector: Detector::Prefix { prefix: "dor_v1_", min_len: 64, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "dp.pt.", min_len: 40, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "pk.eyJ", min_len: 80, charset: Charset::Base64 },
        },
        Rule {
            id: "mapbox-secret-token",
            name: "Mapbox Secret Token",
            detector: Detector::Prefix { prefix: "sk.eyJ", min_len: 80, charset: Charset::Base64 },
        },
        ...
        Rule {
            id: "age-secret-key",
            name: "Age Secret Key",
            detector: Detector::Prefix { prefix: "AGE-SECRET-KEY-", min_len: 59, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "hf_", min_len: 37, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "r8_", min_len: 40, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            id: "groq-api-key",
            name: "Groq API Key",
            detector: Detector::Prefix { prefix: "gsk_", min_len: 52, charset: Charset::AlphaNum },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "sk-ant-api03-", min_len: 108, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "grok-2-api-key",
            name: "Grok-2 API Key",
            detector: Detector::Prefix { prefix: "xai-grok2-", min_len: 64, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "gpt-5-api-key",
            name: "GPT-5 API Key",
            detector: Detector::Prefix { prefix: "sk-gpt5-", min_len: 64, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "gemini-ultra-api-key",
            name: "Gemini Ultra API Key",
            detector: Detector::Prefix { prefix: "AIzaSy", min_len: 39, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "midjourney-v6-api-key",
            name: "Midjourney V6 API Key",
            detector: Detector::Prefix { prefix: "mj-", min_len: 40, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "stability-ai-v3-key",
            name: "Stability AI V3 API Key",
            detector: Detector::Prefix { prefix: "sk-stability-", min_len: 64, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "postgres://", min_len: 20, charset: Charset::Url },
        },
        Rule {
            id: "postgresql-uri",
            name: "PostgreSQL Connection URI",
            detector: Detector::Prefix { prefix: "postgresql://", min_len: 20, charset: Charset::Url },
        },
        Rule {
            id: "mysql-uri",
            name: "MySQL Connection URI",
            detector: Detector::Prefix { prefix: "mysql://", min_len: 15, charset: Charset::Url },
        },
        Rule {
            id: "mongodb-uri",
            name: "MongoDB Connection URI",
            detector: Detector::Prefix { prefix: "mongodb://", min_len: 20, charset: Charset::Url },
        },
        Rule {
            id: "mongodb-srv-uri",
            name: "MongoDB SRV Connection URI",
            detector: Detector::Prefix { prefix: "mongodb+srv://", min_len: 20, charset: Charset::Url },
        },
        Rule {
            id: "redis-uri",
            name: "Redis Connection URI",
            detector: Detector::Prefix { prefix: "redis://", min_len: 15, charset: Charset::Url },
        },
        ...
        Rule {
            ...
            detector: Detector::Contains { needle: "-----BEGIN RSA PRIVATE KEY-----" },
        },
        Rule {
            id: "private-key-openssh",
            name: "OpenSSH Private Key",
            detector: Detector::Contains { needle: "-----BEGIN OPENSSH PRIVATE KEY-----" },
        },
        Rule {
            id: "private-key-ec",
            name: "EC Private Key",
            detector: Detector::Contains { needle: "-----BEGIN EC PRIVATE KEY-----" },
        },
        Rule {
            id: "private-key-generic",
            name: "Private Key",
            detector: Detector::Contains { needle: "-----BEGIN PRIVATE KEY-----" },
        },
        ...
        Rule {
            ...
            name: "Generic Token",
            detector: Detector::KeyValue {
                keys: &["token", "TOKEN", "access_token", "ACCESS_TOKEN", "auth_token", "AUTH_TOKEN"],
                min_value_len: 20,
            },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "jdbc:", min_len: 20, charset: Charset::Url },
        },
        ...
        Rule {
            ...
            detector: Detector::Endpoint {
                keys: &["OLLAMA_HOST", "OLLAMA_BASE_URL", "OLLAMA_API_BASE", "ollama_host", "ollama_url"],
        ...
        Rule {
            ...
            detector: Detector::Endpoint {
                keys: &["LMSTUDIO_HOST", "LMSTUDIO_BASE_URL", "LM_STUDIO_URL", "lmstudio_host"],
        ...
        Rule {
            ...
            detector: Detector::Endpoint {
                keys: &["EXO_HOST", "EXO_BASE_URL", "EXO_API_BASE", "exo_host", "exo_url"],
        ...
        Rule {
            ...
            detector: Detector::Endpoint {
                keys: &["LOCALAI_HOST", "LOCALAI_BASE_URL", "LOCAL_AI_URL", "localai_host"],
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["OPENAI_BASE_URL", "OPENAI_API_BASE", "openai_base_url", "openai_api_base"],
                min_value_len: 10,
            },
        },
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["ETHEREUM_PRIVATE_KEY", "ETH_PRIVATE_KEY", "PRIVATE_KEY", "ethereum_private_key"],
                min_value_len: 64,
            },
        },
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["MNEMONIC", "SEED_PHRASE", "WALLET_MNEMONIC", "mnemonic", "seed_phrase"],
                min_value_len: 50,
            },
        },
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["POLYGON_PRIVATE_KEY", "MATIC_PRIVATE_KEY", "polygon_private_key"],
                min_value_len: 64,
            },
        },
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["AVALANCHE_PRIVATE_KEY", "AVAX_PRIVATE_KEY", "avalanche_private_key"],
                min_value_len: 64,
            },
        },
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["ARBITRUM_PRIVATE_KEY", "ARB_PRIVATE_KEY", "arbitrum_private_key"],
                min_value_len: 64,
            },
        },
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["OPTIMISM_PRIVATE_KEY", "OP_PRIVATE_KEY", "optimism_private_key"],
                min_value_len: 64,
            },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "wc:", min_len: 50, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "kyber", min_len: 32, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "pq-crystals-dilithium",
            name: "CRYSTALS-Dilithium Key",
            detector: Detector::Prefix { prefix: "dilithium", min_len: 32, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "pq-falcon",
            name: "Falcon Signature Key",
            detector: Detector::Prefix { prefix: "falcon", min_len: 32, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "pq-sphincs",
            name: "SPHINCS+ Key",
            detector: Detector::Prefix { prefix: "sphincs", min_len: 32, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "pq-bike",
            name: "BIKE Key",
            detector: Detector::Prefix { prefix: "bike", min_len: 32, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "pq-hqc",
            name: "HQC Key",
            detector: Detector::Prefix { prefix: "hqc", min_len: 32, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::Prefix { prefix: "newhope", min_len: 32, charset: Charset::AlphaNumDash },
        },
        Rule {
            id: "pq-frodo",
            name: "FrodoKEM Key",
            detector: Detector::Prefix { prefix: "frodo", min_len: 32, charset: Charset::AlphaNumDash },
        },
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["HF_MODEL_TOKEN", "HUGGINGFACE_MODEL_TOKEN", "hf_model_token"],
                min_value_len: 20,
            },
        },
        Rule {
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["GCP_SA_TOKEN", "SERVICE_ACCOUNT_TOKEN", "gcp_service_account_token"],
                min_value_len: 20,
            },
        },
        Rule {
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["FEDERATED_TOKEN", "IDENTITY_TOKEN", "federated_identity_token"],
                min_value_len: 20,
            },
        },
        ...
        Rule {
            ...
            detector: Detector::Contains { needle: "mongodb://" },
        },
        Rule {
            id: "mongodb-srv-credentials",
            name: "MongoDB SRV with Credentials",
            detector: Detector::Contains { needle: "mongodb+srv://" },
        },
        ...
        Rule {
            ...
            detector: Detector::Contains { needle: ".mongodb.net" },
        },
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["MONGODB_URI", "MONGO_URI", "MONGO_URL", "MONGODB_URL", "MONGO_CONNECTION_STRING", "mongodb_uri"],
                min_value_len: 20,
            },
        },
        ...
        Rule {
            ...
            detector: Detector::KeyValue {
                keys: &["DATABASE_URL", "DB_URL", "DB_CONNECTION_STRING", "database_url"],
                min_value_len: 15,
            },
        },
    ]
...
mod tests {
    ...
    fn test_builtin_rules_count() {
        ...
        assert!(rules.len() >= 50, "Should have at least 50 builtin rules, got {}", rules.len());
    }
    ...
    fn test_rule_ids_are_kebab_case() {
        ...
        for rule in &rules {
            assert!(
                rule.id.chars().all(|c| c.is_ascii_lowercase() || c.is_ascii_digit() || c == '-'),
    ...
    fn test_has_aws_rules() {
        assert!(has_rule("aws-access-key-id"), "Should have AWS access key rule");
        assert!(has_rule("aws-secret-key"), "Should have AWS secret key rule");
    }
    ...
    fn test_has_github_rules() {
        ...
        assert!(has_rule("github-fine-grained"), "Should have GitHub fine-grained PAT rule");
    }

    #[test]
    fn test_has_gitlab_rules() {
        assert!(has_rule("gitlab-pat"), "Should have GitLab PAT rule");
        assert!(has_rule("gitlab-pipeline"), "Should have GitLab pipeline rule");
    }

    #[test]
    fn test_has_openai_rules() {
        assert!(has_rule("openai-api-key"), "Should have OpenAI API key rule");
        assert!(has_rule("openai-project-key"), "Should have OpenAI project key rule");
    }

    #[test]
    fn test_has_anthropic_rules() {
        assert!(has_rule("anthropic-api-key"), "Should have Anthropic API key rule");
        assert!(has_rule("anthropic-api-key-env"), "Should have Anthropic env var rule");
    }

    #[test]
    fn test_has_xai_grok_rules() {
        assert!(has_rule("xai-api-key"), "Should have xAI API key rule");
        assert!(has_rule("xai-api-key-env"), "Should have xAI/Grok env var rule");
    }

    #[test]
    fn test_has_gemini_rules() {
        assert!(has_rule("gemini-api-key"), "Should have Gemini API key rule");
        assert!(has_rule("gcp-api-key"), "Should have GCP API key rule");
    }

    #[test]
    fn test_has_openrouter_rules() {
        assert!(has_rule("openrouter-api-key"), "Should have OpenRouter API key rule");
    }
    ...
    fn test_has_perplexity_rules() {
        assert!(has_rule("perplexity-api-key"), "Should have Perplexity API key rule");
    }

    #[test]
    fn test_has_fireworks_rules() {
        assert!(has_rule("fireworks-api-key"), "Should have Fireworks API key rule");
    }

    #[test]
    fn test_has_cerebras_rules() {
        assert!(has_rule("cerebras-api-key"), "Should have Cerebras API key rule");
    }

    #[test]
    fn test_has_huggingface_rules() {
        assert!(has_rule("huggingface-token"), "Should have Hugging Face token rule");
    }

    #[test]
    fn test_has_replicate_rules() {
        assert!(has_rule("replicate-token"), "Should have Replicate token rule");
    }

    #[test]
    fn test_has_slack_rules() {
        assert!(has_rule("slack-bot-token"), "Should have Slack bot token rule");
        assert!(has_rule("slack-user-token"), "Should have Slack user token rule");
    }

    #[test]
    fn test_has_stripe_rules() {
        assert!(has_rule("stripe-secret-key"), "Should have Stripe secret key rule");
        assert!(has_rule("stripe-restricted-key"), "Should have Stripe restricted key rule");
    }
    ...
    fn test_has_mongodb_extended_rules() {
        assert!(has_rule("mongodb-credentials"), "Should have MongoDB credentials rule");
    ...
    fn test_has_private_key_rules() {
        assert!(has_rule("private-key-rsa"), "Should have RSA private key rule");
        assert!(has_rule("private-key-openssh"), "Should have OpenSSH private key rule");
        assert!(has_rule("private-key-ec"), "Should have EC private key rule");
    }

    #[test]
    fn test_has_local_ai_endpoint_rules() {
        assert!(has_rule("ollama-endpoint"), "Should have Ollama endpoint rule");
        assert!(has_rule("lmstudio-endpoint"), "Should have LM Studio endpoint rule");
        assert!(has_rule("exo-endpoint"), "Should have Exo endpoint rule");
        assert!(has_rule("localai-endpoint"), "Should have LocalAI endpoint rule");
        assert!(has_rule("vllm-endpoint"), "Should have vLLM endpoint rule");
        assert!(has_rule("llamacpp-endpoint"), "Should have llama.cpp endpoint rule");
        assert!(has_rule("kobold-endpoint"), "Should have Kobold endpoint rule");
    }

    #[test]
    fn test_has_generic_rules() {
        assert!(has_rule("generic-api-key"), "Should have generic API key rule");
        assert!(has_rule("generic-secret"), "Should have generic secret rule");
        assert!(has_rule("generic-password"), "Should have generic password rule");
    ...
    fn test_has_contains_detectors() {
        ...
        assert!(count >= 4, "Should have contains detectors for private keys");
    }
    ...
    fn test_prefix_detectors_have_reasonable_min_len() {
        let rules = builtin_rules();
        for rule in &rules {
            if let Detector::Prefix { min_len, prefix, .. } = &rule.detector {
                assert!(
                    *min_len >= prefix.len(),
